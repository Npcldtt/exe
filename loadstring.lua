...
local compile = require(game:HttpGet("raw.githubusercontent.com/Npcldtt/exe/refs/heads/main/Yueliang.lua"))
local createExecutable = require(game:HttpGet("raw.githubusercontent.com/Npcldtt/exe/refs/heads/main/fiOne.lua"))
getfenv().script = nil
